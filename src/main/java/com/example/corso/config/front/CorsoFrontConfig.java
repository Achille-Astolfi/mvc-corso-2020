package com.example.corso.config.front;
...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = "com.example.corso.controller")
public class CorsoFrontConfig extends WebMvcConfigurerAdapter {
